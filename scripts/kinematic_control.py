...
from sas_kuka_control_template.kinematics import get_kinematics
from dqrobotics_extensions.singularity_controller.task_space_controller import TaskSpaceController
...
def main(args=None):
    ...
    try:
        ...
        with TaskSpaceController(kinematics=robot_kinematics, order=cfg["order"], datalogger=datalogger_client) as task_space_controller:
            task_space_controller.set_gain(cfg["controller_gain"])
            task_space_controller.set_damping(cfg["damping"])
            task_space_controller.set_alpha(cfg["alpha"])
            task_space_controller.set_sigma_min(cfg["sigma_min"])
